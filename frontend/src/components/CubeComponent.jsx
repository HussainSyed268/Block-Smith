...
import "../styles/CubeComponent.css"
  ...
  return (
    <div id="wrapper">
      <div className="viewport">
        <div className="cube">
          <div className="side" style={{ backgroundColor: '#61677A', width: '150px', height: '150px' }}></div>
          <div className="side" style={{ backgroundColor: '#61677A', width: '150px', height: '150px' }}></div>
          <div className="side" style={{ backgroundColor: '#61677A', width: '150px', height: '150px' }}></div>
          <div className="side" style={{ backgroundColor: '#61677A', width: '150px', height: '150px' }}></div>
          <div className="side" style={{ backgroundColor: '#61677A', width: '150px', height: '150px' }}></div>
          <div className="side" style={{ backgroundColor: '#61677A', width: '150px', height: '150px' }}></div>
          <div className="inner-square square1">
            <div className="col co1"></div>
          </div>
          <div className="inner-square square2">
            <div className="col co2"></div>
          </div>
          <div className="inner-square square3">
            <div className="col col3"></div>
          </div>
          <div className="inner-square square4">
            <div className="col col4"></div>
          </div>
          <div className="inner-square square5">
            <div className="col col5"></div>
          </div>
          <div className="inner-square square6">
